...
class _MyAppState extends State<TheMap>
{
  ...
  getData() async {
    try {
      final response =
      await http.get('https://maps.googleapis.com/maps/api/place/nearbysearch/json?location='+'1.348176, 103.855548' +'&radius=1500&type=hospital&key=AIzaSyBoTJ8MwgJlQ07zjEw3SSyUrPh0Tcveu6E');
